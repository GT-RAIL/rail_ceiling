...
v4l2-ctl --device=/dev/video0  --set-ctrl=exposure_absolute=60

v4l2-ctl --device=/dev/video1 --set-ctrl=exposure_auto=1
v4l2-ctl --device=/dev/video1  --set-ctrl=exposure_absolute=60

v4l2-ctl --device=/dev/video2 --set-ctrl=exposure_auto=1
v4l2-ctl --device=/dev/video2  --set-ctrl=exposure_absolute=60
